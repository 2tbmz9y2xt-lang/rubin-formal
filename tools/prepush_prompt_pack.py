...
- You may open the current repo's relevant `AGENTS.md` files for repo-specific review rules,
  including the repo root and any narrower in-repo scopes that govern the touched paths.
